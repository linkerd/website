...
[service profile](/2.10/features/service-profiles/). Once a service
...
[books demo](/2.10/tasks/books/#service-profiles).
...
- Linkerd discovers the right service profile to use via `:authority` or
  ...
  [ingress](/2.10/features/ingress/) for one reason. Another would be clients that
