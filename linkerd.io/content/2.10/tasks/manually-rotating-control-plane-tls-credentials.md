...
[generated manually](/2.10/tasks/generate-certificates/).
...
rotation](/2.10/tasks/automatically-rotating-control-plane-tls-credentials/). This
...
Certificates Guide](/2.10/tasks/replacing_expired_certificates/) instead.
...
certificates](/2.10/tasks/generate-certificates/).
