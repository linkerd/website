...
These metrics are part of the [`linkerd viz routes`](/2.10/reference/cli/viz/#routes)
command instead of [`linkerd viz stat`](/2.10/reference/cli/viz/#stat). To see the
