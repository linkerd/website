...
[Automatically Rotating Control Plane TLS Credentials](/2.10/tasks/use_external_certs/).
...
[Linkerd upgrade](/2.10/tasks/upgrade/) (using the Linkerd CLI or using Helm) will
regenerate them.
...
and issuer credentials as described in [Installing Linkerd with Helm](/2.10/tasks/install-helm/).
{{< /note >}}
...
Credentials](/2.10/tasks/automatically-rotating-control-plane-tls-credentials/)
