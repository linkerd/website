...
Linkerd's [automatic mTLS](/2.10/features/automatic-mtls/) feature uses a set of
...
rotated](/2.10/tasks/manually-rotating-control-plane-tls-credentials/) on
long-lived clusters.)
...
Credentials](/2.10/tasks/automatically-rotating-webhook-tls-credentials/) for how
