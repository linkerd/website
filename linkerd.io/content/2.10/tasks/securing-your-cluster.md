...
- [`linkerd viz tap`](/2.10/reference/cli/viz/#tap)
- [`linkerd viz top`](/2.10/reference/cli/viz/#top)
- [`linkerd viz profile --tap`](/2.10/reference/cli/viz/#profile)
- [`linkerd viz dashboard`](/2.10/reference/cli/viz/#dashboard)
...
By default, the [Linkerd dashboard](/2.10/features/dashboard/) has the RBAC
