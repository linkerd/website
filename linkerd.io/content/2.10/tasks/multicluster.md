...
[introduction](/2.10/features/multicluster/) that explains how this works beneath
...
[deep dive](/2.10/features/automatic-mtls/#how-does-it-work).
...
[issuer credentials](/2.10/tasks/generate-certificates/#issuer-certificate-and-key)
...
the [certificate documentation](/2.10/tasks/generate-certificates/) for more
details.
...
its [automatic mTLS](/2.10/features/automatic-mtls/) across clusters to make sure
...
[docs](/2.10/tasks/securing-your-service/). To quickly check, however, you can run:
...
this sounds a lot like how we do [canary](/2.10/tasks/canary-release/) deployments,
you'd be correct!
