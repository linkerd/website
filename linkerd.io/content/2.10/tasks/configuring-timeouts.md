...
of extra information to the [service profile](/2.10/features/service-profiles/) for
...
Check out the [timeouts section](/2.10/tasks/books/#timeouts) of the books demo for
...
rate](/2.10/tasks/configuring-retries/#monitoring-retries).  Since the request was
