...
| field        | value                                                                                                              |
| ------------ | ------------------------------------------------------------------------------------------------------------------ |
| `parentRefs` | A set of [ParentReference](#parentreference)s which indicate which Servers or Services this HTTPRoute attaches to. |
...
HTTPRoutes can be attached to a [Server](authorization-policy/#server) to allow
defining an [authorization policy](authorization-policy/#authorizationpolicy)
for specific routes served on that Server.
