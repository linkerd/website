...
- TLS version 1.3
- Cipher suite `TLS_CHACHA20_POLY1305_SHA256` as specified in
  [RFC 8446](https://www.rfc-editor.org/rfc/rfc8446#section-9.1).

## Caveats and future work

- Linkerd does not _require_ mTLS unless
  [authorization policies](server-policy/) are configured.
