...
multicluster links, available starting with Linkerd `edge-25.4.4`. In this method, the
...
from earlier versions of Linkerd (pre-`edge-25.4.4`), where (in addition to the Link
