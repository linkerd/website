...
2. [Pods are great, until they’re not]({{< ref "a-service-mesh-for-kubernetes-part-ii-pods-are-great-until-theyre-not" >}}) (this article)
...
![request path diagram](/uploads/2017/07/buoyant-k8s-daemonset-mesh.png)
