...
[request-level load balancing](/2/features/load-balancing/), this also allows
Linkerd to handle failures of individual pods. In Linkerd, you specify retries
as part of a [service profile](/2/features/service-profiles/) (introduced in a
[previous blog post](/2018/12/08/service-profiles-for-per-route-metrics/)).
...
setting a [timeouts](/2/features/retries-and-timeouts/#timeouts) another new
