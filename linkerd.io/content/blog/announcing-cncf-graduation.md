...
This is a victory for every engineer who has championed the virtues of
simplicity and minimalism and rejected the narrative that service meshes must
be complex and slow.

This is a victory for every platform owner who has chosen a service mesh based
on [performance
...
Most of all, this is a victory for every person around the world who—whether
...
Linkerd has a long history of firsts: Linkerd was the first service mesh. It
was the first project to enter the CNCF's inception (now sandbox) phase. It was
the first CNCF project to adopt Rust—a language we now believe is [the future
of the
...
including Google, IBM, Amazon, and Microsoft, launched and marketed their own
...
Buoyant Cloud](https://buoyant.io/). And it's only July!

Finally, just as the CNCF has helped shape Linkerd, Linkerd has also helped
shape the CNCF: Linkerd's "service mesh" neologism is now used by the CNCF's to
[define cloud native](https://github.com/cncf/toc/blob/main/DEFINITION.md)
itself.

## What's next for Linkerd?

Graduation is a moment of gratitude and reflection, but it's not a moment of
pause. In fact, there's never been a better time to get involved with Linkerd.
...
than any other mesh out there. It's built on a foundation of secure and
future-forward technologies like Rust rather than legacy technology like C++.
Most importantly, Linkerd is built with a singular focus on, and empathy for,
the user—and in the end, that empathy must and will prevail.
...
A special thank you to Dave Zolotusky, Lee Calcote, Chris Aniszczyk, and Amye
Scavarda Perrin for helping us through the graduation process.
