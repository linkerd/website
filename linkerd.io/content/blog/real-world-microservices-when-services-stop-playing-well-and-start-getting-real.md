...
`/srv => /io.l5d/default/http`

`/io.l5d.k8s/default/http/users`
...
This concept of contextual resolution can be extended to alter how _individual requests_are routed. Suppose you want to stage a new version of a service and you want to get an idea how the application will behave with the new version. Assume that this service isn’t directly user-facing, but has other services that call it—a “users” service is generally a good example. You have a few options:
...
We’ve published the [linkerd-examples](https://github.com/linkerd/linkerd-examples) repository with examples of how to run linkerd & namerd on [Kubernetes](https://github.com/linkerd/linkerd-examples/tree/master/getting-started/k8s) and [Mesos + Marathon](https://github.com/linkerd/linkerd-examples/tree/master/dcos). These repositories should have everything you need to get up and routing. If you have any questions along the way, please don’t hesitate to ask us on [slack.linkerd.io](http://slack.linkerd.io/).
