...
In this post we’ll explore how Linkerd can be used as an _egress\* as well, handling requests from services within the cluster to services running outside of the cluster, whether those are legacy non-Kubernetes systems or third-party APIs outside the firewall.
...
![image](/uploads/2017/07/buoyant-k8s-egress-dtab.png)
