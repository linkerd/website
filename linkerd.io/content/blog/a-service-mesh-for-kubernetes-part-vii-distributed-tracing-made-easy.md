...
7. [Distributed tracing made easy]({{< ref "a-service-mesh-for-kubernetes-part-vii-distributed-tracing-made-easy" >}}) (this article)
...
![image](/uploads/2017/07/buoyant-k8s-tracing-search-1-large-1024x352.png)

Clicking on the trace from this view will bring up the trace detail view:

![image 1](/uploads/2017/07/buoyant-k8s-tracing-trace-1-large-1024x360.png)
...
![image 2](/uploads/2017/07/buoyant-k8s-tracing-span-1-large-1024x712.png)
...
There are some additional benefits to forwarding context headers, beyond tracing. From our [previous blog post](/distributed-tracing-for-polyglot-microservices/#request-context) on the topic:
