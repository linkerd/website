...
good](/2016/06/17/small-memory-jvm-techniques-for-microservice-sidecars/)
...
protocol](/2/features/protocol-detection/) that's in use. So
...
Linkerd's [automatic mutual TLS](/2/features/automatic-mtls/)
...
service](/2/features/automatic-mtls/#how-does-it-work) to
...
service](/2/reference/architecture/#destination). Whether or
...
domain](/2/tasks/using-custom-domain/). The Destination
...
](/2/features/service-profiles/)that configures retries,
...
averages](/2016/03/16/beyond-round-robin-load-balancing-for-latency/),
