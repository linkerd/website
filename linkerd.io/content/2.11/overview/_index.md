...
Linkerd has three basic components: a UI, a _data plane_, and a _control plane_.
You run Linkerd by:
...
Once a service is running with Linkerd, you can use
[Linkerd's UI](../getting-started/#step-4-explore-linkerd) to inspect and
manipulate it.
...
You can learn more about the proxies in the
[Linkerd proxy repo](https://github.com/linkerd/linkerd2-proxy).
