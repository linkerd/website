...
through Helm and the CLI. If the external Prometheus is secured with basic auth,
...
Linkerd's Prometheus will still be included in the installation. If you wish to
