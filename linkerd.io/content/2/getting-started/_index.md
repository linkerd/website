...
broken! Specifically, if you click on the donut emoji (🍩), you'll get a 404
page.  Don't worry, this errors are intentional. (And we can use Linkerd to
identify the problem. Check out the [debugging guide](../debugging-an-app/) if
you're interested in how to figure out exactly what is wrong.)
